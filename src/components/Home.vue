<template>
  <div class="home container mx-auto">
    <h6
      class="mt-8 font-mono text-sm text-purple"
      v-if="!modifySettings"
    ...
    <h6
      class="mt-8 cursor-pointer hover:text-purple"
      v-if="!modifySettings"
      @click="modifySettings = true"
    >
      Settings
          ...
          <div class="flex -mx-2 mt-4 mb-4">
            <div class="mx-2 w-1/3">
              ...
              <input
                ...
                id="host"
                type="text"
                placeholder="https://sdk-testnet.aepps.com"
              />
            </div>
            <div class="mx-2 w-1/3">
    ...
    <div v-if="this.account.priv && this.account.pub && this.url">
      <h1 class="py-2">
        ...
        <span v-if="this.clientError" class="text-sm text-red">
          ...
          <span class="cursor-pointer underline" @click="modifySettings = true"
            >Modify Settings</span
          >
          <br />
          {{ this.clientError }}
        </span>
      ...
      <div class="mt-8 -mx-2" v-if="!this.clientError">
        <div class="w-full p-4 bg-grey-light rounded-sm shadow">
          ...
          <div class="relative">
            ...
            <div class="absolute pin-b pin-r">
              <select
                v-model="cmOption.keyMap"
                class="block appearance-none w-full py-2 px-4 rounded-none pr-8"
              >
        ...
        <div class="flex mt-8 mb-8" v-if="byteCode">
          <div class="w-1/2 p-4 bg-grey-light rounded-sm shadow">
            <h2 class="py-2">
              ...
              <div
                ...
                v-bind:class="{
                  'text-red': !deployedDataObj,
                  'text-green': deployedDataObj,
                }"
              >
                {{ deployInfo }}
              </div>
          ...
          <div
            ...
            class="w-1/2 p-4 bg-grey-light rounded-sm shadow"
          >
            ...
            <div class="flex -mx-2 mt-4 mb-4">
              ...
              <div class="mx-2 w-1/2">
                <label class="text-xs block mb-1" for="staticSophiaTypeInput"
                  >Return Type</label
                >
                <input
                  v-model="staticSophiaType"
                  class="w-full p-2"
                  id="staticSophiaTypeInput"
                  type="text"
        ...
        <div
          v-if="deployedDataObj && byteCode"
          class="w-full p-4 bg-grey-light rounded-sm shadow mb-8"
        >
          ...
          <div class="flex -mx-2 mt-4 mb-4">
            ...
            <div class="mx-2 w-1/3">
              <label class="text-xs block mb-1" for="sophiaTypeInput"
                >Return Type</label
              >
              <input
                v-model="sophiaType"
          ...
          <span v-if="waitingCall" class="text-sm text-red"
...
export default {
  ...
  methods: {
    ...
    async deploy(initArgs, options = {}) {
      ...
      try {
        const contractInstance = await this.client.getContractInstance(
          this.contractCode,
        );
    ...
    async callStatic(func, args) {
      ...
      return {
        decoded: await res.decode(this.staticSophiaType),
        result: res.result,
      };
    },
    ...
    onCallStatic() {
      if (this.staticFunc) {
        ...
        this.callStaticError =
          'Please enter a Function and 1 or more Arguments.';
      }
    },
    ...
    async getClient() {
      if (this.account.priv && this.account.pub && this.url) {
        try {
          ...
          const account = {
            secretKey: this.account.priv,
            publicKey: this.account.pub,
          };
